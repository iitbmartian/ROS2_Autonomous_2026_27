...
def limit_log_level_to_info(log_unit, log_level):
    """Build a --log-level value for one unit, capping DEBUG at INFO.

    Inlined from husarion_ugv_utils.logging, which has no Jazzy release.
    """
