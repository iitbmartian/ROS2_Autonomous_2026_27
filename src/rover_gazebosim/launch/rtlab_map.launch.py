...
def generate_launch_description():
    ...
    rltconfig = os.path.join(get_package_share_directory('rover_gazebosim'), 'config','rtlab_params.ini')
    ...
    return LaunchDescription([
        ...
        # Config files
        DeclareLaunchArgument('cfg',      default_value= rltconfig,                        description='To change RTAB-Map\'s parameters, set the path of config file (*.ini) generated by the standalone app.'),
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/front_cam/color/image_raw',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/front_cam/depth/image_raw', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/front_cam/color/camera_info',            description=''),
        ...
        DeclareLaunchArgument('scan_topic',           default_value='/second_lidar/scan',       description=''),
        DeclareLaunchArgument('subscribe_scan_cloud', default_value='false',       description=''),
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/second_lidar/scan/points', description=''),
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='/imu_relay', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
