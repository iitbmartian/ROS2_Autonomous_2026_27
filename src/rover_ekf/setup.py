...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'steer_wheel_splitter = rover_ekf.steer_wheel_splitter:main',
            'steer_wheel_relay = rover_ekf.steer_wheel_relay:main',
            'wheel_body_velocity = rover_ekf.wheel_body_velocity:main',
        ],
    },
)
