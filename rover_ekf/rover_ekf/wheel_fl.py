...
#   ros2 run odomshi wheel_fl_relay --ros-args -p noise_stddev:=0.05
NOISE_MEAN = 0.0
...
WHEEL_NAME = "wheel_fl"
RAW_TOPIC = "/wheel_fl/encoder"
RELAYED_TOPIC = "/wheel_fl/odom_relayed"
NOISE_MODE_TOPIC = "/wheel_fl/noise_mode"
...
class WheelFLRelay(Node):

    def __init__(self):
        super().__init__('wheel_fl_relay')
