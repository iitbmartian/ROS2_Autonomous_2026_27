...
#   ros2 run odomshi wheel_fr_relay --ros-args -p noise_stddev:=0.05
NOISE_MEAN = 0.0
...
WHEEL_NAME = "wheel_fr"
RAW_TOPIC = "/wheel_fr/encoder"
RELAYED_TOPIC = "/wheel_fr/odom_relayed"
NOISE_MODE_TOPIC = "/wheel_fr/noise_mode"
...
class WheelFRRelay(Node):

    def __init__(self):
        super().__init__('wheel_fr_relay')
