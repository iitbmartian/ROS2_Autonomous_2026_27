...
#   ros2 run odomshi wheel_rl_relay --ros-args -p noise_stddev:=0.05
NOISE_MEAN = 0.0
...
WHEEL_NAME = "wheel_rl"
RAW_TOPIC = "/wheel_rl/encoder"
RELAYED_TOPIC = "/wheel_rl/odom_relayed"
NOISE_MODE_TOPIC = "/wheel_rl/noise_mode"
...
class WheelRLRelay(Node):

    def __init__(self):
        super().__init__('wheel_rl_relay')
